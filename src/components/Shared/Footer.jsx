            ...
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                ...
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
                    <p className="text-sm text-gray-500">
                        © Copyright 2023 | AngelStudio | All rights reserved.
                    </p>
                    <div className="flex items-center mt-4 space-x-4 sm:mt-0">
                        <a
                            target='_blank'
                            href="https://twitter.com/AngelStudio"
                        ...
                        <a
                            target='_blank'
                            href="https://www.instagram.com/AngelStudio"
                            className="text-gray-500 transition-colors duration-300 hover:text-teal-accent-400" rel="noreferrer"
                        >
                        ...
                        <a
                            target='_blank'
                            href="https://www.facebook.com/AngelStudio/"
                            className="text-gray-500 transition-colors duration-300 hover:text-teal-accent-400" rel="noreferrer"
                        >
                            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
